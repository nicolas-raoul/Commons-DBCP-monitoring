...
public class AbandonedObjectPool extends GenericObjectPool {
    ...
    public Object borrowObject() throws Exception {
    	...
    	String stack = Arrays.toString(new Exception().getStackTrace());
    	System.out.println("DBCPMONITOR;+0;+1;AbandonnedObjectPool.borrowObject#first;" + time + ";" + id + ";" + stack);
    	...
    	stack = Arrays.toString(new Exception().getStackTrace());
    	System.out.println("DBCPMONITOR;+1;-1;AbandonnedObjectPool.borrowObject#last;" + time + ";" + id + ";" + stack);
    ...
    public void returnObject(Object obj) throws Exception {
    	...
    	String id = Thread.currentThread().getName();
    	String stack = Arrays.toString(new Exception().getStackTrace());
    	System.out.println("DBCPMONITOR;-1;+0;AbandonnedObjectPool.returnObject;" + time + ";" + id + ";" + stack);
    ...
    public void invalidateObject(Object obj) throws Exception {
    	...
    	String id = Thread.currentThread().getName();
    	String stack = Arrays.toString(new Exception().getStackTrace());
    	System.out.println("DBCPMONITOR;-1;+0;AbandonnedObjectPool.invalidateObject;" + time + ";" + id + ";" + stack);
